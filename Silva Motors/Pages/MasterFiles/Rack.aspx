<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Rack.aspx.cs" Inherits="Silva_Motors.Pages.MasterFiles.Rack1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <link rel="stylesheet" href='<%= ResolveUrl("~/Content/CustomCSS/MasterFiles/RackCSS.css") %>' />
    <div class="container-fluid main">
        <div class="header">ITEM RACK</div>
        ...
        <div class="table-responsive">
            <asp:GridView ID="gvracks" runat="server" AutoGenerateColumns="false"
                CssClass="table table-bordered rack-table" Width="100%">
                <Columns>
