<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Model.aspx.cs" Inherits="Silva_Motors.Pages.MasterFiles.Model1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <link rel="stylesheet" href='<%= ResolveUrl("~/Content/CustomCSS/MasterFiles/ModelCSS.css") %>' />
    <div class="container-fluid main">
        ...
        <div class="table-responsive">
            <asp:GridView ID="gvmodels" runat="server" AutoGenerateColumns="false"
                CssClass="table table-bordered model-table" Width="100%">
                <Columns>
