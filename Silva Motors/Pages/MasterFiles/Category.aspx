<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="Silva_Motors.Pages.MasterFiles.Category1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <link rel="stylesheet" href='<%= ResolveUrl("~/Content/CustomCSS/MasterFiles/CategoryCSS.css") %>' />
    <div class="container-fluid main">
        ...
        <div class="table-responsive">
            <asp:GridView ID="gvcategorys" runat="server" AutoGenerateColumns="false"
                CssClass="table table-bordered category-table" Width="100%">
                <Columns>
